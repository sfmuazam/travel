...
class TransactionResource extends Resource
{
                            ...
                            Section::make('Payment')
                                ->schema([
                                    ...
                                    Placeholder::make('bank')
                                        ->dehydrated(false)
                                        ->live()
                                        ->label('Bank Details (Manual Verification)')
                                        ->hidden(function (Get $get) {
                                            return $get('payment_method') != 'transfer';
                                        })
                                        ->content(function () {
                                            $bankInfo = Website::select('invoice_bank')->first();

                                            $bankDetails = $bankInfo->invoice_bank;

                                            $output = '<ul>';
                                            foreach ($bankDetails as $bank) {
                                                $output .= '<li class="mb-2">';
                                                $output .= '<strong>Bank:</strong> ' . htmlspecialchars($bank['bank']) . '<br>';
                                                $output .= '<strong>Name:</strong> ' . htmlspecialchars($bank['name']) . '<br>';
                                                $output .= '<strong>Account:</strong> ' . htmlspecialchars($bank['account']);
                                                $output .= '</li>';
                                            }
                                            $output .= '</ul>';
                                    ...
                                    Section::make('VA Number (Real-Time Verification)')
                                        ->hidden(function (Get $get) {
                                            return $get('payment_method') != 'va';
                                        })
                                            ...
                                            Select::make('bank_va')
                                                ...
                                                ->options(
                                                    [
                                                        ...
                                                        //     $options[$bank->va_number] = $bank->name;
                                                        // }
                                                        // return $options;
                                                        'bri' => 'BRI',
                                                        'bca' => 'BCA',
    ...
    {
        return [
            RelationManagers\FinancialRelationManager::class,
