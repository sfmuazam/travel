                ...
                <div class="card py-1 px-2">
                    ...
                    <div class="py-2">
                        ...
                        <div class="form-group">
                            ...
                            <select id="duration" class="form-control" wire:model="durationRange">
                                <option value="">All Durations</option>
                                <option value="0-10">0-10 days</option>
                                <option value="11-20">11-20 days</option>
                                <option value="21-30">21-30 days</option>
                                <option value="31-50">31-50 days</option>
                            </select>
                        </div>
                        <div class="form-group">
                            <label for="sortField">Sort By</label>
                            <select id="sortField" class="form-control" wire:model="sortField">
                        ...
                        <div class="form-group">
                            ...
                            <select id="sortDirection" class="form-control" wire:model="sortDirection">
                                <option value="asc">Ascending</option>
                                <option value="desc">Descending</option>
                            </select>
                        </div>
                        <button class="btn btn-primary mt-3" wire:click="applyFilters">Apply Filters</button>
                    </div>
                </div>
            </div>
            <div class="col-9 px-1" id="packageList">
                        ...
                        <div class="col-6">
                            <div class="card h-100 container-packages">
                                <div class="position-relative">
                                    <img src="{{ asset('storage/' . $row->thumbnail) }}" height="300"
                                ...
                                <div class="card-body position-relative pb-5 mb-2">
                                    <h5 class="card-title text-wrap">{{ $row->name }}</h5>
                                    <div class="px-2">
                                        ...
                                        <div class="d-flex justify-content-between align-items-center lh-base">
                                            ...
                                            <div class="lh-lg" id="facility">
                                                <span class="d-flex align-items-center column-gap-1">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="16"
                                                        height="16" fill="currentColor" class="bi bi-collection"
                                                        viewBox="0 0 16 16">
                                                        <path
                                                ...
                                                <div class="ms-3">
                                                    @if ($row->id_airline)
                                                        <span
                                                            class="d-flex align-items-center column-gap-1 lh-base fs-7">
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="16"
